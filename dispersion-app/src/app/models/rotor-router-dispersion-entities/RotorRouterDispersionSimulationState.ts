import {RotorRouterDispersionNode} from "./RotorRouterDispersionNode";
import {Edge, VisEdge} from "../base-entities/Edge";
import {RotorRouterDispersionRobot} from "./RotorRouterDispersionRobot";
import {NodeState, VisNode} from "../base-entities/Node";


export class RotorRouterDispersionSimulationState {

  nodes: RotorRouterDispersionNode[] | any[];
  edges: Edge[];
  robots: RotorRouterDispersionRobot[];
  counter: number;

  init(object: any): RotorRouterDispersionSimulationState {
  ...
  initialize(nodes: VisNode[], edges: VisEdge[], robots: RotorRouterDispersionRobot[]): RotorRouterDispersionSimulationState {
  ...
  converter(simulationState: RotorRouterDispersionSimulationState): any {
    return  {
