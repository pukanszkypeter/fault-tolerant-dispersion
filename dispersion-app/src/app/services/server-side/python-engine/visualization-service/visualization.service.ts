...
export class VisualizationService {
  ...
  summarize(summaryBy: string): Observable<any> {
    return this.http.post<any>(
      PythonEngineRoute + VisualizationServiceRoutes.VISUALIZATION + VisualizationServiceRoutes.SUMMARY_BY,
      {summaryBy: summaryBy}
    );
  }
  ...
  groupBy(algorithmType: string, graphType: string, groupBy: string): Observable<any> {
    return this.http.post<any>(
      PythonEngineRoute + VisualizationServiceRoutes.VISUALIZATION + VisualizationServiceRoutes.GROUP_BY,
  ...
  detailBy(detailBy: string, algorithmType: string, graphType: string): Observable<any> {
    return this.http.post<any>(
      PythonEngineRoute + VisualizationServiceRoutes.VISUALIZATION + VisualizationServiceRoutes.DETAIL_BY,
