...
export class GraphGeneratorService {
  ...
  generateGraph(
    ...
    switch (type) {
      case 'SIMPLE_LINE':
        return this.generateSimpleLine(nodes, robots, startNodes);
      case 'CIRCLE':
        return this.generateCircleGraph(nodes, robots, startNodes);
      case 'COMPLETE':
        return this.generateCompleteGraph(nodes, robots, startNodes);
      case 'BARBELL':
        return this.generateBarbellGraph(nodes, robots, startNodes);
      case 'LOLLIPOP':
        return this.generateLollipopGraph(nodes, robots, startNodes);
      case 'SPECIAL_LINE':
        return this.generateSpecialLine(nodes, robots, startNodes);
      case 'GRID':
        return this.generateGridGraph(nodes, robots, startNodes);
      case 'HYPER_CUBE':
        return this.generateHyperCube(nodes, robots, startNodes);
      case 'ER_RANDOM':
