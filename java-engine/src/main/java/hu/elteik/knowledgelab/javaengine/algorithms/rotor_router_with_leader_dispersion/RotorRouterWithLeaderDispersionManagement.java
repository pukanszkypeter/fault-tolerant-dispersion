...
@Component
public class RotorRouterWithLeaderDispersionManagement implements RotorRouterWithLeaderDispersionManager<RotorRouterWithLeaderDispersionNode, RotorRouterWithLeaderDispersionEdge, RotorRouterWithLeaderDispersionRobot> {

    @Override
    public void step(Graph<RotorRouterWithLeaderDispersionNode, RotorRouterWithLeaderDispersionEdge> graph, List<RotorRouterWithLeaderDispersionRobot> robotList) {
    ...
    private void look(Graph<RotorRouterWithLeaderDispersionNode, RotorRouterWithLeaderDispersionEdge> graph, List<RotorRouterWithLeaderDispersionRobot> robotList) {
        ...
        for (Map.Entry<Long, List<RotorRouterWithLeaderDispersionRobot>> robotsByRotorRouterWithLeaderNode : robotsOnDifferentRotorRouterWithLeaderNodes.entrySet()) {
            ...
            Map<Color, List<RotorRouterWithLeaderDispersionRobot>> robotsGroupedByColorOnRotorRouterWithLeaderNode = robotsByRotorRouterWithLeaderNode.getValue()
                    .stream().collect(groupingBy(RotorRouterWithLeaderDispersionRobot::getColor));

            for (Map.Entry<Color, List<RotorRouterWithLeaderDispersionRobot>> robotsByColor : robotsGroupedByColorOnRotorRouterWithLeaderNode.entrySet()) {
                // There is at least two leader on this node
                if (leaderCount(robotsByColor.getValue()) > 1) {
                    List<RotorRouterWithLeaderDispersionRobot> currentLeadersInOneRotorRouterWithLeaderNode = getCurrentLeaders(robotsByColor.getValue());
                    // Recalculate the winner leader
                    RotorRouterWithLeaderDispersionRobot winnerLeader = new LocalLeaderElection<RotorRouterWithLeaderDispersionRobot>().run(currentLeadersInOneRotorRouterWithLeaderNode);
                    for (RotorRouterWithLeaderDispersionRobot robot : currentLeadersInOneRotorRouterWithLeaderNode){
                    ...
                    RotorRouterWithLeaderDispersionRobot winnerRotorRouterWithLeaderRobot = new LocalLeaderElection<RotorRouterWithLeaderDispersionRobot>().run(robotsByColor.getValue());
    ...
    private void compute(Graph<RotorRouterWithLeaderDispersionNode, RotorRouterWithLeaderDispersionEdge> graph, List<RotorRouterWithLeaderDispersionRobot> robotList) {
        ...
        for (Map.Entry<Long, List<RotorRouterWithLeaderDispersionRobot>> leadersByRotorRouterWithLeaderNode : leadersOnDifferentRotorRouterWithLeaderNodes.entrySet()) {
            ...
            if (isRotorRouterWithLeaderNodeOccupied(graph, leadersByRotorRouterWithLeaderNode.getKey())) {
                ...
                if (robotCountOnRotorRouterWithLeaderNode(robotList, leadersByRotorRouterWithLeaderNode.getKey()) == 1) {
                    ...
                    List<RotorRouterWithLeaderDispersionRobot> followersInEveryColor = robotList.stream()
                    ...
                    if (followersInEveryColor.size() < 1) {
                        ...
                        RotorRouterWithLeaderDispersionRobot winnerLeader = new LocalLeaderElection<RotorRouterWithLeaderDispersionRobot>().run(leadersByRotorRouterWithLeaderNode.getValue());

                        for (RotorRouterWithLeaderDispersionRobot leader : leadersByRotorRouterWithLeaderNode.getValue()) {
                        ...
                        RotorRouterWithLeaderDispersionRobot settlerFollower = new LocalLeaderElection<RotorRouterWithLeaderDispersionRobot>().run(followersInEveryColor);

                        // Find the leader of the settler
                        RotorRouterWithLeaderDispersionRobot leaderForSettler = robotList.stream().filter(robot -> robot.getState().equals(RobotState.LEADER)
                        ...
                        for (RotorRouterWithLeaderDispersionRobot otherLeader : leadersByRotorRouterWithLeaderNode.getValue()) {
    ...
    private void move(Graph<RotorRouterWithLeaderDispersionNode, RotorRouterWithLeaderDispersionEdge> graph, List<RotorRouterWithLeaderDispersionRobot> robotList) {
        ...
        for (Map.Entry<Long, List<RotorRouterWithLeaderDispersionRobot>> robotsByRotorRouterWithLeaderNode : robotsOnDifferentRotorRouterWithLeaderNodes.entrySet()) {
            ...
            for (Map.Entry<Color, List<RotorRouterWithLeaderDispersionRobot>> robotsByColor : robotsGroupedByColorOnRotorRouterWithLeaderNode.entrySet()) {
                RotorRouterWithLeaderDispersionRobot leader = robotsByColor.getValue().stream().filter(robot -> robot.getState().equals(RobotState.LEADER))
                        .collect(Collectors.toList()).get(0);
                if (leader.getOnID().equals(leader.getDestinationID())) {
                    ...
                    for (RotorRouterWithLeaderDispersionRobot follower : robotsByColor.getValue().stream().filter(robot -> robot.getState().equals(RobotState.EXPLORE)).collect(Collectors.toList())) {
    ...
    private Long robotCountOnRotorRouterWithLeaderNode(List<RotorRouterWithLeaderDispersionRobot> robotList, Long nodeID) {
        return robotList.stream().filter(robot -> robot.getOnID().equals(nodeID)).count();
    }

    private List<RotorRouterWithLeaderDispersionRobot> getCurrentLeaders(List<RotorRouterWithLeaderDispersionRobot> robotList) {
        return robotList.stream().filter(robot -> robot.getState().equals(RobotState.LEADER)).collect(Collectors.toList());
    }

    private boolean isRotorRouterWithLeaderNodeOccupied(Graph<RotorRouterWithLeaderDispersionNode, RotorRouterWithLeaderDispersionEdge> graph, Long nodeID) {
    ...
    private Long getNewPath(Graph<RotorRouterWithLeaderDispersionNode, RotorRouterWithLeaderDispersionEdge> graph, Long onID, Color color) {
        ...
        RotorRouterWithLeaderDispersionNode currentRotorRouterWithLeaderNode = graph.getNodeList().stream().filter(node -> node.getID().equals(onID)).collect(Collectors.toList()).get(0);
    ...
    private void setTheFirstPortIndexOnRotorRouterWithLeaderNode(Graph<RotorRouterWithLeaderDispersionNode, RotorRouterWithLeaderDispersionEdge> graph, RotorRouterWithLeaderDispersionRobot leaderRotorRouterWithLeaderRobot) {
        RotorRouterWithLeaderDispersionNode currentRotorRouterWithLeaderNode = graph.getNodeList().stream()
        ...
        if (leaderRotorRouterWithLeaderRobot.getLastUsedEdgeID() == null) {
            ...
            List<RotorRouterWithLeaderDispersionEdge> edgeOptionOnTheNewRotorRouterWithLeaderNode = graph.getEdgeList().stream()
