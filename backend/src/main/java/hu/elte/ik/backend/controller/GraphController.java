...
public class GraphController {
    ...
    public ResponseEntity<Graph<Node, Edge>> barabasiAlbertGraph(
        ...
        return ResponseEntity.ok(
                graphService.barabasiAlbertGraph(
                        init, edge, node));
    }
    ...
    public ResponseEntity<Graph<Node, Edge>> hyperCubeGraph(
        ...
        return ResponseEntity.ok(
                graphService.hyperCubeGraph(
                        dimension));
    }

    @GetMapping("/linear")
    public ResponseEntity<Graph<Node, Edge>> linearGraph(
            @RequestParam int size) {
        return ResponseEntity.ok(
                graphService.linearGraph(
                        size));
    }
    ...
    public ResponseEntity<Graph<Node, Edge>> lollipopGraph(
            @RequestParam int size) {
        return ResponseEntity.ok(
                graphService.lollipopGraph(
                        size));
    }

    @GetMapping("/ring")
    public ResponseEntity<Graph<Node, Edge>> ringGraph(
            @RequestParam int size) {
        return ResponseEntity.ok(
                graphService.ringGraph(
                        size));
    }
    ...
    public ResponseEntity<Graph<Node, Edge>> randomRegularGraph(
        ...
        return ResponseEntity.ok(
                graphService.randomRegularGraph(
                        node, degree));
    }

    @GetMapping("/star")
    public ResponseEntity<Graph<Node, Edge>> starGraph(
            @RequestParam int order) {
        return ResponseEntity.ok(
                graphService.starGraph(
                        order));
    }

    @GetMapping("/wheel")
    public ResponseEntity<Graph<Node, Edge>> wheelGraph(
            @RequestParam int size) {
        return ResponseEntity.ok(
                graphService.wheelGraph(
                        size));
    }
    ...
    public ResponseEntity<Graph<Node, Edge>> windmillGraph(
            ...
            @RequestParam int size) {
        return ResponseEntity.ok(
                graphService.windmillGraph(
                        Mode.valueOf(mode), copies, size));
    }
