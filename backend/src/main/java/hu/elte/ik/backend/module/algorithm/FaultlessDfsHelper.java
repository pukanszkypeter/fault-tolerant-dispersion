...
@Component
public class FaultlessDfsHelper implements Stepper<FaultlessDfsNode, FaultlessDfsEdge, FaultlessDfsRobot> {

        @Override
        public void step(Graph<FaultlessDfsNode, FaultlessDfsEdge> graph, List<FaultlessDfsRobot> robotList) {
