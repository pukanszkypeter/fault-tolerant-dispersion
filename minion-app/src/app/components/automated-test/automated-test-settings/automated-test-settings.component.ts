...
@Component({
  ...
  templateUrl: './automated-test-settings.component.html',
  styleUrls: ['./automated-test-settings.component.css']
})
export class AutomatedTestSettingsComponent implements OnInit {

  @Output() settingsEvent = new EventEmitter<{simulationConfiguration: SimulationConfiguration, tests: number}>();
